...
import product2 from "../data/images/product2.jpg";
...
function Ecommerce() {
  const [selectedValue, setSelectedValue] = useState("March 2021");
  const {
    currentColor,
    sparklineData,
    pieChartData,
  ...
  const handleDropDownChange = (args) => {
    setSelectedValue(args.itemData.Time);
  };
    ...
    <div className="mt-10">
      ...
      <div className="flex gap-10 m-4 flex-wrap justify-center">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl w-96 md:w-760">
          ...
          <div className="md:w-full overflow-auto">
            <LineChart selectedValue={selectedValue} />
          </div>
        </div>
      </div>
      <div className="flex flex-wrap justify-center">
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          ...
          <div className="mt-10">
            <img className="md:w-96 h-50 " src={product2} alt="" />
            <div className="mt-8">
